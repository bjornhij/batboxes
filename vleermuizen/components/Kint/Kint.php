...
if (!function_exists('d')) {
            ...
            {
                $argv = func_get_args();
                call_user_func_array(array('app\components\Kint\Kint', 'dump'), $argv);
            }
...
$GLOBALS['_kint_settings'] = array (
	 ...
	 */
	'pathDisplayCallback' => "app\components\Kint\Kint::_debugPath",
...
class Kint extends Component
{
    ...
    * @param mixed $var
    **/
    private static function __dump($var)
    {
       return var_dump($var);   
    }
