...
--
-- Name: visit_observers; Type: TABLE; Schema: public; Owner: vleermuizen; Tablespace: 
--

CREATE TABLE visit_observers (
    id integer NOT NULL,
    visit_id integer NOT NULL,
...
ALTER TABLE public.visit_observers OWNER TO vleermuizen;

--
-- Name: visit_observers_id_seq; Type: SEQUENCE; Schema: public; Owner: vleermuizen
--
...
--
-- Name: visit_observers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: vleermuizen
--

ALTER SEQUENCE visit_observers_id_seq OWNED BY visit_observers.id;
...
ALTER TABLE ONLY visit_observers
    ADD CONSTRAINT pk_vo_id PRIMARY KEY (id);
...
ALTER TABLE ONLY visit_observers
    ADD CONSTRAINT fk_vo_observer_id_u_id FOREIGN KEY (observer_id) REFERENCES users(id) MATCH FULL ON UPDATE RESTRICT ON DELETE SET NULL;


--
-- Name: fk_vo_visit_id_v_id; Type: FK CONSTRAINT; Schema: public; Owner: vleermuizen
--

ALTER TABLE ONLY visit_observers
    ADD CONSTRAINT fk_vo_visit_id_v_id FOREIGN KEY (visit_id) REFERENCES visits(id) MATCH FULL ON UPDATE RESTRICT ON DELETE SET NULL;
